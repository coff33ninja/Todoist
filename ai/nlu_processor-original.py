...
class NLUProcessor:
    def __init__(self,
        ...
        def _init_or_load_metadata(self) -> ModelMetadata:
            """Initialize or load model metadata.

            Returns:
                ModelMetadata object with current model information
            """
            if os.path.exists(self.metadata_path):
                try:
                    ...
                    logger.warning("Failed to load metadata: %s. Creating new.", str(e))
